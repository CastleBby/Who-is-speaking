...
## Pipeline Overview:
Phase 1: Detect mouth motion signal for one face
Phase 2: Add multi-face tracking with persistent IDs
Phase 3: Estimate active Speaker
Phase 4: Add overlap and turn taking cues 
